...
def map_ai_code_to_severity(diagnosis_code: int) -> str:
    """
    Map mã lỗi AI (0, 1, 2, 3) sang mức độ nghiệp vụ thực tế
    - 0: Normal -> INFO (Thường không tạo incident)
    - 1: Performance Issue -> WARNING / MEDIUM
    - 2: Exception -> CRITICAL
    - 3: Return/Truncated -> INFO / LOW
    """
    mapping = {
        1: "WARNING",   
        2: "CRITICAL",  
    ...
    return mapping.get(diagnosis_code, "INFO")
...
class LogProcessingService:
    ...
    def process_and_save(self, payload: dict, ai_result: dict):
        ...
        severity_level = map_ai_code_to_severity(diagnosis_code)
        ...
        if existing_prediction:
            ...
            if existing_incident:
                ...
                existing_incident.severity = severity_level
